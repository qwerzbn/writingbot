      ...
      <div className="h-full overflow-y-auto bg-slate-50 p-8 dark:bg-slate-950">
        <div className="mx-auto flex max-w-7xl flex-col gap-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <div className="text-sm font-medium text-slate-500 dark:text-slate-400">Notebook</div>
          ...
          {loading ? (
            ...
            <div className="space-y-5">
              {orderedNotebooks.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-slate-200 bg-white px-5 py-4 text-sm text-slate-500 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400">
              ...
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
                ...
                >
                  ...
                  <div className="mt-6 text-2xl font-medium text-slate-900 dark:text-white">
                    Create new notebook
                  </div>
                </button>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      >
                        ...
                        <div className="mt-5 truncate text-2xl font-medium text-slate-900 dark:text-white">
                          {notebook.name}
                        </div>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <button
                            type="button"
                            className="flex h-10 w-10 items-center justify-center rounded-full text-slate-400 transition hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-slate-200"
        ...
        <DialogContent className="max-w-md rounded-3xl border-slate-200 bg-white p-0 shadow-xl dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="px-6 py-6">
            ...
            <input
              ...
              className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-900 outline-none transition focus:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:focus:border-slate-600"
            />
          </div>
