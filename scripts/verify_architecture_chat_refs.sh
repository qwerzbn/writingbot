...
declare -a CHECKS=(
  ...
  "src/agent_runtime/runtime.py|def _stream_content_run(|agent runtime content stream"
  "src/agent_runtime/runtime.py|def _retrieve_content_bundle(|agent runtime retrieve bundle"
  "src/retrieval/hybrid.py|def retrieve(|hybrid retrieval entry"
