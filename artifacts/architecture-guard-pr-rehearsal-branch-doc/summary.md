...
- artifact_dir: `artifacts/architecture-guard-pr-rehearsal-branch-doc`
- failure_exit_code: `1`
...
```text
[verify-arch-chat] validating code anchors
[verify-arch-chat] arch_doc=/var/folders/6x/r1zsj0h94kd1s9cgmyh88pt40000gn/T/tmp.mpmp02MyVH
[verify-arch-chat] total_checks=11
